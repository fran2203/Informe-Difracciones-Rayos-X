...
Debido a la periodicidad de la red, los planos cristalinos se repiten también peroódicamente. La distancia entre dos planos sucesivos se denomina distancia interplanar $d.$ En una red FCC, la distancia interplanar está dada por
\begin{equation}
...
donde $f_{cat}$ y $f_{an}$ son los factores atómicos del catión y el anión respectivamente. Como los factores atómicos son proporcionales al número atómico, en el caso de planos con índices impares, si los números atómicos son similares la intensidad medida es muy baja, lo que se denomina \textit{extinción sistemática de picos}.
