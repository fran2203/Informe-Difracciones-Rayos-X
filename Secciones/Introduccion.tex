...
Como se observa en la Figura \ref{fig: red_cristalina}, al unir los puntos de la red se forman celdas repetidas periódicamente a lo largo de la red. Dichas celdas se denominan celdas unidad y  la estructura es obtenida por repetición de dicha celda. En la Figura \ref{fig: red_cristalina} se muestra en remarcado en negro distintas celdas unidad posibles.
De esta forma la red queda definida al indicar las distancias entre puntos en tres direcciones y los ángulos entre dichas direcciones. Dichas distancias y angulos forman vectores llamados parámetros de red de la celda unidad.

Hay solo 14 tipos de celdas unidad posibles, las llamadas redes de Bravais. Cualquier otra celda hallada es equivalente a una de estas 14. Una red simple es aquella que tiene un punto de red por celda, mientras que una no primitiva tiene más de una \cite{cullity}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth]{Imagenes/1000041.png}
