...
\title{\textbf{Caracterización de soluciones sólidas de $\ce{KCl_{1-x}Br_x}$ mediante difracción de rayos X}}
\author{
...
\begin{@twocolumnfalse}
    ...
    además de las sales puras $\ce{NaCl}$ y $\ce{LiCl}.$ Los parámetros de red obtenidos para las soluciones sólidas fueron de $\SI{5,144\pm0,003}{\angstrom}$ para el $\ce{LiCl},$
